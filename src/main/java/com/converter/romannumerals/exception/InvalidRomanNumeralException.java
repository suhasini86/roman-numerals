 ...
 * <ul>
 *   <li>Input value outside the supported range (e.g., less than {@value RomanNumeralsConstants#MIN_VALUE}
 *   or greater than {@value RomanNumeralsConstants#MAX_VALUE})</li>
 ...
 * typically thrown from the service layer and handled globally
